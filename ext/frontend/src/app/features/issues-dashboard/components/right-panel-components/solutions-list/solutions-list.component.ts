...
import {
  DetailedIssueDTO,
  DetailedIssueScore,
} from 'app/shared/interfaces/DetailedIssueDTO';
import { MatDialog } from '@angular/material/dialog';
import { MetricsService } from 'app/shared/services/metrics.service';
import { ReportIssueAnalysisComponent } from 'app/features/issues-dashboard/components/right-panel-components/report-issue-analysis/report-issue-analysis.component';
...
export class SolutionsListComponent {
  ...
  public copyLink(link: string): void {
    ...
    this.toastrService.success(
      this.translateService.instant('FEATURES.ISSUES.LINK_COPIED_TO_CLIPBOARD')
    );
    this.metricsService.copySourcesLinkClick(this.activeIssue.id).subscribe();
  }
